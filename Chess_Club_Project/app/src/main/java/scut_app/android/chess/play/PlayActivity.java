...
import scut_app.android.chess.GamesListActivity;
import scut_app.android.chess.helpers.MyPGNProvider;
import scut_app.android.chess.R;
import scut_app.android.chess.activities.ChessBoardActivity;
import scut_app.android.chess.activities.GlobalPreferencesActivity;
import scut_app.android.chess.constants.ColorSchemes;
import scut_app.android.chess.constants.PieceSets;
import scut_app.android.chess.engine.EngineApi;
import scut_app.android.chess.engine.EngineListener;
import scut_app.android.chess.engine.LocalEngine;
import scut_app.android.chess.helpers.PGNHelper;
import scut_app.android.chess.helpers.ResultDialogListener;
import scut_app.android.chess.services.ClockListener;
import scut_app.android.chess.services.EcoService;
import scut_app.android.chess.services.GameApi;
import scut_app.android.chess.services.LocalClockApi;
import scut_app.android.chess.views.CapturedCountView;
import scut_app.android.chess.views.ChessPieceView;
import scut_app.android.chess.views.ChessPiecesStackView;
        ...
        switch (requestCode) {
            case REQUEST_MENU:
                ...
                if (item.equals(getString(R.string.menu_game_settings))) {
                    ...
                    intent = new Intent();
                    intent.setClass(PlayActivity.this, scut_app.android.chess.setup.SetupActivity.class);
